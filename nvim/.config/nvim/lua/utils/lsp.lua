...
M.on_attach = function(event)
	...
	keymap("n", "<leader>sD", "<cmd>Lspsaga show_line_diagnostics<CR>", opts) -- Line diagnostics (float)
	keymap("n", "<leader>sd", "<cmd>Lspsaga show_cursor_diagnostics<CR>", opts) -- Cursor diagnostics
